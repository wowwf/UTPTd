...
public interface UTPAuditorServices {
	//判断是否存在这个审核人员
	boolean FindByIdAndRole(String IdCard);
	//判断审核人员登录信息是否对应
	boolean FindPassword(String IdCard, Integer Role, String Password);
	...
	PageResult LikeQueryTeacherById(String IdCard, Page page);
	//根据分页查询技术人员的模糊查询
	PageResult LikeQueryTechnical(String Name, Page page);
	
	PageResult LikeQueryTechnicalById(String IdCard, Page page);
	//判断是否存在
	boolean isRegiest(String iD, String uName);
	//修改密码
	void doResetPass(String iD, String Name, String passWord);
}
